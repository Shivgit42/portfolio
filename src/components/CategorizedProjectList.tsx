    ...
    <div className="w-full">
      <Tabs defaultValue="full stack apps" className="w-full">
        <div className="flex justify-center mb-8 max-sm:mb-4 max-sm:px-2">
          <TabsList className="w-full max-w-xl max-sm:max-w-4xl bg-white bg-opacity-10 backdrop-blur-lg border dark:border-white/10 grid grid-cols-1 sm:grid-cols-4 gap-1">
            <TabsTrigger
              value="full stack apps"
              className="text-xs sm:text-sm data-[state=active]:bg-black/50"
            >
              Full Stack
            </TabsTrigger>
            <TabsTrigger
